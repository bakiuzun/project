...
public class Turtle extends Vivant {
    ...
    public void updateState(){
        deltaHunger = ActionConstant.DELTA_HUNGER_TURTLE; 
        deltaHygiene = ActionConstant.DELTA_HYGIENE_TURTLE;  
        deltaMood = ActionConstant.DELTA_MOOD_TURTLE; 
        deltaTiredness = ActionConstant.DELTA_TIREDNESS_TURTLE;  
        deltaWeight = ActionConstant.DELTA_WEIGHT_TURTLE; 
        super.updateState();
    }
